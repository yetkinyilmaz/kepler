...
#        self.add_body(x=[50., 0.], v=[0., np.sqrt(0.02)], m=0.00001)
#        self.add_body(x=[100., 0.], v=[0., 0.10], m=0.00001)

        self.add_body(x=[52., 0.3], v=[0., np.sqrt(0.02)], m=0.00001)
        self.add_body(x=[98., 0.], v=[0., 0.1], m=0.00001)
